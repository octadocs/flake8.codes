...
exponential numbers.
  ...
  - Reasoning:  
    ...
    meaningless leading zeros to the number itself. `` `0b1 `` is the
    same as `` `0b01 `` and `` `0b001 ``. How can a language be called
    consistent if you can write numbers in an infinite ways? It hurts
